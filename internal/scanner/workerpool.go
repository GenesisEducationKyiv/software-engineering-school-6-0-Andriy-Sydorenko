...
// NewWorkerPool returns a pool that runs at most size handlers
// concurrently. size <= 0 falls back to 1 so callers can't accidentally
// configure a deadlocked pool.
