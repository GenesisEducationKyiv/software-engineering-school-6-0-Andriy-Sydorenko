// Package catalogdb owns the Catalog service's Postgres connection and its own
// migration set, kept separate from the other services' databases.
package catalogdb
...
// Migrate applies pending Catalog migrations (golang-migrate, schema_migrations table).
