...
const (
	NotifierService_SendEmail_FullMethodName = "/notifier.v1.NotifierService/SendEmail"
)
...
//
// NotifierService delivers pre-rendered transactional email.
//
// Delivery is at-least-once: a retried call may send the same email twice, so
// callers must tolerate rare duplicates. The service is content-agnostic — the
// caller renders the HTML; the notifier only sends it.
...
func (c *notifierServiceClient) SendEmail(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*SendEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotifierService_SendEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotifierService_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotifierService_SendEmail_FullMethodName,
	}
