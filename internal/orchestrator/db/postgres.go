// Package orchestratordb owns the Orchestrator's Postgres connection and its own
// migration set (the saga_log), kept separate from the participants' databases.
package orchestratordb
